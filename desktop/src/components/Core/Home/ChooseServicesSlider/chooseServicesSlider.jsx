...
const ChooseServicesSlider = (props) => {
        ...
        <div className="choose-services__slider mt-20">
            <div className="col">
                <div className="choose-services__slider__content">
                    <figure className="icon-service-bg">
                        <i className="icon-service1"></i>
                    </figure>
                    <strong>Text Resume</strong>
                    <p>Get a competitive edge with resume that highlights your strengths and eraknesses</p>
                    <strong className="price">1100/-</strong>
                    <button type="button" class="btn btn-outline-primary mt-20">View details</button>
                </div>
            </div>
            <div className="col">
                <div className="choose-services__slider__content">
                    <figure className="icon-service-bg">
                        <i className="icon-service2"></i>
                    </figure>
                    <strong>Visual Resume</strong>
                    <p>Use visuals to enhance and highlight your experience</p>
                    <strong className="price">2300/-</strong>
                    <button type="button" class="btn btn-outline-primary mt-20">View details</button>
                </div>
            </div>
            <div className="col">
  ...
  return (
    ...
    <div className="container-fluid mt-50 bg">
        <div className="row">
