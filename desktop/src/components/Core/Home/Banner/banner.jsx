...
//     altText: '<div><h1>jkjslf</h1></div>',
//     caption: '<div><h1>jkjslf</h1></div>'
//   },
//   {
                ...
                <div className="carousel-content">
                    <div className="row">
                        <div className="col">
                            ...
                            <h1>Get a well crafted professional resume</h1>
                        ...
                        <div className="col">
                            <img src="/media/images/banner-img1.png" alt="Shine Resume Services" />
                        </div>
                    </div>
                </div>
            </div>
